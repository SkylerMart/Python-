...
def load_gui(self):
    ...
    self.lbl_fname.grid(row=0,column=2,padx=(27,0),pady=(10,0),sticky=N+W)
    ...
    self.btn_close = tk.Button(self.master,width=12, height=2, text='Add', command=lambda: phonebook_func.ask_quit(self))
